...
public class BottomNavigationViewHelper {
    ...
    public static void startMenuAnim(BottomNavigationView view, int position, Animation animation) {
        BottomNavigationMenuView menuView = (BottomNavigationMenuView) view.getChildAt(0);
    ...
    @SuppressLint("NewApi")
    public static void stopMenuAnim(BottomNavigationView view, int pos) {
        BottomNavigationMenuView menuView = (BottomNavigationMenuView) view.getChildAt(0);
